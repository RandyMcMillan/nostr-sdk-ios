...
struct _1630EventDetailView: View {
    var event: NostrEvent
...
struct _1630EventListView: View {
        ...
        NavigationView {
            List {
                ForEach(events, id: \.id) { event in
                    ...
                    NavigationLink(destination: _1630EventDetailView(event: event)) {
                        _1630EventRowView(event: event)
                    }
                }
            }
...
struct _1630QueryRelayDemoView: View {
...
// 30617 30618 1617 1621 1630 1631 1632 1633
    ...
    @State private var selectedKind = 1630
...
struct _1630QueryRelayView_Previews: PreviewProvider {
