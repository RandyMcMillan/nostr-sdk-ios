...
struct _1631EventDetailView: View {
    var event: NostrEvent
...
struct _1631EventListView: View {
        ...
        NavigationView {
            List {
                ForEach(events, id: \.id) { event in
                    ...
                    NavigationLink(destination: _1631EventDetailView(event: event)) {
                        _1631EventRowView(event: event)
                    }
                }
            }
...
struct _1631QueryRelayDemoView: View {
...
// 30617 30618 1617 1621 1630 1631 1632 1633
    ...
    @State private var selectedKind = 1631
...
struct _1631QueryRelayView_Previews: PreviewProvider {
